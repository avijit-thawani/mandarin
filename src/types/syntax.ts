...
export const SEMANTIC_TAGS: Record<string, string[]> = {
  time: ['今天', '明天', '昨天', '现在', '上午', '下午', '晚上', '早上', '凌晨', '星期', '月', '年', '小时', '分钟', '中午', '一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月', '星期一', '星期二', '星期三', '星期四', '星期五', '星期六', '星期天'],
  time_unit: ['星期', '月', '年', '星期一', '星期二', '星期三', '星期四', '星期五', '星期六', '星期天'],
